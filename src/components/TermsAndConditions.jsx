...
const TermsAndConditions = () => {
  return (
    ...
    <div className="p-6 pt max-w-4xl mt-20 mx-3 shadow-md rounded-lg">
      ...
      <li className="mb-4 text-gray-300 text-justify">
        ...
        regulations, privacy policy and Terms of Use for access or usage of domain name <b>www.way2skills.
        com</b> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 
        'Platform').
      </li>
      <li className="mb-4 text-gray-300 text-justify">
        The Platform is owned by <b>WAY2SKILLS</b>, a company incorporated under the Companies Act, 
        1956 with its registered office at <b>6 54A MELAPATTI NEAR SMN POULTRY FARM 
        MELAPATTI NAMAKKAL TAMIL NADU IN 637020</b> (hereinafter referred to as ‘Platform 
        Owner’, 'we', 'us', 'our').
      </li>
      <li className="mb-4 text-gray-300 text-justify">
      ...
      <li className="mb-4 text-gray-300 text-justify">The use of Platform and/or availing of our Services is subject to the following Terms of Use:</li>
      
      <ul className="list-decimal pl-6 text-gray-300">
        <li className="mb-4 text-gray-300 text-justify">To access and use the Services, you agree to provide true, accurate and complete information 
        ...
        <li className="mb-4 text-gray-300 text-justify">Neither we nor any third parties provide any warranty or guarantee as to the accuracy, 
        ...
        <li className="mb-4 text-gray-300 text-justify">Your use of our Services and the Platform is solely and entirely at your own risk and 
        ...
        <li className="mb-4 text-gray-300 text-justify">The contents of the Platform and the Services are proprietary to us and are licensed to us. 
          You will not have any authority to claim any intellectual property rights, title, or interest in 
          its contents. The contents include and are not limited to the design, layout, look and graphics.</li>
        <li className="mb-4 text-gray-300 text-justify">You acknowledge that unauthorized use of the Platform and/or the Services may lead to 
          action against you as per these Terms of Use and/or applicable laws.</li>
        <li className="mb-4 text-gray-300 text-justify">You agree to pay us the charges associated with availing the Services.</li>
        <li className="mb-4 text-gray-300 text-justify">You agree not to use the Platform and/or Services for any purpose that is unlawful, illegal or 
          forbidden by these Terms, or Indian or local laws that might apply to you.</li>
        <li className="mb-4 text-gray-300 text-justify">You agree and acknowledge that website and the Services may contain links to other third 
        ...
        <li className="mb-4 text-gray-300 text-justify">You understand that upon initiating a transaction for availing the Services you are entering 
          into a legally binding and enforceable contract with the Platform Owner for the Services.</li>
        <li className="mb-4 text-gray-300 text-justify">You shall indemnify and hold harmless Platform Owner, its affiliates, group companies (as 
...
delayed by a force majeure event..
          ...
          jurisdiction of the courts in <b>Namakkal</b> and <b>Tamil Nadu</b>.
          </li>
          <li className="mb-4 text-gray-300 text-justify">
      ...
      <p className="mt-4 text-gray-300">For any concerns, please contact us via the provided information on our website.</p>
    </div>
    </div>
    </>
  );
